        ...
        <div className="relative mx-auto max-w-6xl px-6">
          <div className="text-center">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Button asChild size="lg" className="h-12 px-8 text-base shadow-lg shadow-violet-500/25">
                <a href="/dashboard">
                  Mulai Sekarang
              ...
              return (
                ...
                >
                  ...
                  <CardHeader className="pb-2">
                    <div className={`inline-flex w-fit rounded-xl ${feature.bgColor} p-3 shadow-lg`}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card className="border-border/50 bg-gradient-to-br from-violet-50 to-purple-50 dark:from-violet-950/20 dark:to-purple-950/20">
                <CardContent className="p-6">
                  <p className="text-4xl font-bold text-violet-600 dark:text-violet-400">3</p>
                  <p className="mt-1 text-sm text-muted-foreground">Tools AI</p>
                </CardContent>
              </Card>
              <Card className="border-border/50 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/20 dark:to-cyan-950/20">
                <CardContent className="p-6">
                  <p className="text-4xl font-bold text-blue-600 dark:text-blue-400">PDF</p>
                  <p className="mt-1 text-sm text-muted-foreground">Materi Supported</p>
                </CardContent>
              </Card>
              <Card className="border-border/50 bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20">
                <CardContent className="p-6">
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">Gratis</p>
                </CardContent>
              </Card>
              <Card className="border-border/50 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20">
                <CardContent className="p-6">
                  <p className="text-4xl font-bold text-amber-600 dark:text-amber-400">24/7</p>
                  <p className="mt-1 text-sm text-muted-foreground">Akses</p>
                </CardContent>
              </Card>
            </div>
          </div>
          ...
          <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-violet-600 to-purple-700">
            ...
            <CardContent className="relative p-12 text-center text-white">
              ...
              <Button
                asChild
                size="lg"
                className="mt-8 h-12 bg-white px-8 text-violet-700 hover:bg-white/90"
              >
                <a href="/dashboard">
                  Upload PDF Sekarang
                  <ArrowRight className="ml-2 h-4 w-4" />
